...
# DT1 Диммер симисторный

Одноканальный симисторный диммер

<PrintPage> </PrintPage>

### 💎 Возможности
- Плавная регулировка яркости
- Работает с любыми нагрузками 230 В переменного тока с поддержкой диммирования
- До 700 Вт на канал

![DT1](/img/blocks_photo/DT1_L.jpg)

## ❓ Описание
Симисторный диммер DT1 предназначен для коммутации сигналов и элементов электрических цепей в автоматизированных системах управления освещением, климатом и другими электрическими нагрузками, в сферах промышленности, жилищно-коммунального хозяйства и бытового обслуживания.
...
| Напряжение питания | 10…25 В постоянного тока (номинал 24 В)|
| Потребляемая мощность, не более | 2,5 Вт |
| Количество выходов | 1 |
| Максимальная мощность нагрузки на канал | 700 Вт |
| Максимальный ток нагрузки на канал | 3 А (для нагрузки 230 В переменного тока) |
| Диапазон напряжения нагрузки | 100–250 В переменного тока (50 Гц)|
